          ...
          <section className="bg-white px-10 py-20 rounded-3xl border-2 border-gray-100">
            ...
            <form onSubmit={onRegister} action="">
              ...
              <div className="mt-4 flex flex-col gap-y-2">
                <button className="active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01] ease-in-out py-3 rounded-xl bg-violet-500 text-white text-lg font-bold">Registrarse</button>
